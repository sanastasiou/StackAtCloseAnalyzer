#!/usr/bin/env python3
"""
StackAtClose Analyzer - Standalone Cross-Platform Version
Works on Windows, Linux, and Mac with Python 3.8+
...
def check_and_install_dependencies():
    ...
    if missing:
        print("=" * 60)
        print("StackAtClose Analyzer - First Run Setup")
        print("=" * 60)
...
# Now import the actual analyzer code
...
class CompleteAnalyzer:
    ...
    def _extract_udp_6577(self, pkt_data, timestamp, seen_payloads, packet_num):
        ...
        # Handle proprietary encapsulation (0x9102, 0x2090, etc.)
